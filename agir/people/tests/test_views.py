...
class ProfileTestCase(TestCase):
    ...
    def test_can_load_message_preferences_page(self):
        res = self.client.get(reverse("profile_contact"))
    ...
    def test_can_add_delete_address(self):
        ...
        self.assertRedirects(res, reverse("profile_contact"))
...
class ActivityAblebilityFormTestCases(TestCase):
    ...
    def test_form_is_displayed(self):
        ...
        self.assertContains(response, "Ce que je peux apporter")
...
class InformationPersonalFormTestCases(TestCase):
    ...
    def test_form_is_displayed(self):
        ...
        self.assertContains(response, "J'en dis plus sur moi")
...
class PreferencesFormTestCases(TestCase):
    def setUp(self):
        self.person = Person.objects.create_person("test@test.com")
        self.client.force_login(self.person.role)
...
class ParticipationFormTestCases(TestCase):
    def setUp(self):
        self.person = Person.objects.create_person("test@test.com")
        self.client.force_login(self.person.role)
    ...
    def test_form_is_displayed(self):
        ...
        self.assertContains(
            response, "La participation aux tirages au sort étant paritaire"
        )
...
class ExternalPersonPreferencesFormTestCases(TestCase):
    ...
    def test_form_is_displayed(self):
        ...
        self.assertContains(response, "Rejoindre la France insoumise")
...
class InformationContactFormTestCases(TestCase):
    ...
    def test_form_is_displayed(self):
        url_form = reverse("profile_contact")

        response = self.client.post(
            url_form, data={"contact_phone": "0658985632"}, follow=True
        )

        self.assertContains(response, "l'adresse utilisé pour me contacter")
...
class SMSValidationTestCase(TestCase):
    ...
    def test_cannot_ask_sms_if_already_validated(self):
        ...
        message_preferences_page = reverse("profile_contact")
